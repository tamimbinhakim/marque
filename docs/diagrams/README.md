...
- Avoid colors other than the accent pair in `classDef accent` / `classDef alt` at the top of each file. A monochrome diagram that degrades gracefully in grayscale print beats a five-color diagram that looks busy in every theme.
